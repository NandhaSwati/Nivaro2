    ...
    <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-slate-200">
      <Container>
        <div className="flex h-16 items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm">
            <NavLink to="/" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><HomeIcon className="h-4 w-4" /> Home</NavLink>
    ...
    <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-slate-200">
      <Container>
        <div className="flex h-16 items-center gap-6">
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm">
            <NavLink to="/" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><HomeIcon className="h-4 w-4" /> <span>Home</span></NavLink>
            {token && <NavLink to="/bookings" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><CalendarDaysIcon className="h-4 w-4" /> <span>My Bookings</span></NavLink>}
            <NavLink to="/services/" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><UsersIcon className="h-4 w-4" /> <span>Services</span></NavLink>
          </nav>
          ...
          <div className="hidden md:flex items-center ml-2">
            <div className="relative">
              <MagnifyingGlassIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
              <input placeholder="Search services or helpers" className="input pl-9 pr-3 w-64 text-sm" />
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm">
            {token && <NavLink to="/bookings" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><CalendarDaysIcon className="h-4 w-4" /> My Bookings</NavLink>}
            <NavLink to="/services/" className={({isActive}) => `flex items-center gap-2 hover:text-blue-600 ${isActive ? 'text-blue-600' : 'text-slate-600'}`}><UsersIcon className="h-4 w-4" /> Services</NavLink>
          </nav>
